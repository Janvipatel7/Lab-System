...
const ManageStudent = () => {
  ...
  useEffect(() => {
    if (input.labId) {
      const filteredPc = pcs.filter((pc) => {
        return pc.labId === input.labId && pc.status.toLowerCase() === "available"
      });
      ...
      <div className="bg-white shadow-lg rounded-2xl w-full max-w-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input onChange={handleChange} value={input.name} id="name" placeholder="Enter student name"
          ...
          <div>
            ...
            <input onChange={handleChange} value={input.email} type="email" id="email" placeholder="Enter email"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-black focus:border-black block w-full p-2.5"
            />
          </div>
          ...
          <div>
            ...
            <input onChange={handleChange} value={input.grid} type="number" id="grid" placeholder="Enter GR NO."
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-black focus:border-black block w-full p-2.5"
            />
          </div>
          ...
          <div>
            ...
            <select onChange={handleChange} value={input.labId} id="labId"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-black focus:border-black block w-full p-2.5"
            >
