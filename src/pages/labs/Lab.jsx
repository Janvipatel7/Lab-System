    ...
    return (
        <div className="bg-gray-100 min-h-screen p-4 sm:p-6 md:p-10 text-black">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                <h2 className="text-2xl sm:text-3xl font-bold">Lab Management</h2>
                <button
                ...
                <table className="w-full text-sm sm:text-base text-left bg-white rounded-lg">
                    <thead className="text-xs sm:text-sm uppercase bg-black text-gray-50">
                        <tr>
                            ...
                            <th className="px-4 sm:px-6 py-3 sm:py-4">Capacity</th>
                            <th className="px-4 sm:px-6 py-3 sm:py-4">Remaining Space</th>
                    ...
                    <tbody>
                        {labs.map((lab, idx) => (
                            ...
                            >
                                ...
                                <td className="px-4 sm:px-6 py-3 sm:py-4">{lab.capacity}</td>
                                <td className="px-4 sm:px-6 py-3 sm:py-4">
                                    {lab.spaceLeft === 0 ? "Full" : lab.spaceLeft}
                                </td>
                                <td className="px-4 sm:px-6 py-3 sm:py-4">{lab.location}</td>
                                <td className="px-4 sm:px-6 py-3 sm:py-4">
